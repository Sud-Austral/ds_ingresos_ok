...
## Verificación de nuestros cálculos con datos oficiales (2020)
...
# names(tabla_ing_aut)[3] <- "region" 
# names(tabla_ing_aut)[1] <- "region_c" 
 tabla_ing_aut <- tabla_3[,c("region","2020")]
...
# names(tabla_ing_aut)[3] <- "region" 
# names(tabla_ing_aut)[1] <- "region_c" 
  tabla_ing_aut <- tabla_3[,c("region","2017")]
...
# names(tabla_ing_aut)[3] <- "region" 
# names(tabla_ing_aut)[1] <- "region_c" 
  tabla_ing_aut <- tabla_3[,c("region","2015")]
...
tabla_reg <- data.frame(
  region = i,
  promedio_2013 = mean(rr$ytrabajoCorh)
)
...
# names(tabla_ing_aut)[3] <- "region" 
# names(tabla_ing_aut)[1] <- "region_c" 
  tabla_ing_aut <- tabla_3[,c("region","2013")]
...
tabla_2013$promedio_2013 <- as.numeric(tabla_2013$promedio_2013)
...
tabla_reg <- data.frame(
  region = i,
  promedio_2011 = mean(rr$ytrabhaj)
)
...
# names(tabla_ing_aut)[3] <- "region" 
# names(tabla_ing_aut)[1] <- "region_c" 
  tabla_ing_aut <- tabla_3[,c("region","2011")]
...
tabla_2011$promedio_2011 <- as.numeric(tabla_2011$promedio_2011)
...
tabla_reg <- data.frame(
  region = i,
  promedio_2009 = mean(rr$YTRABHAJ)
)
...
# names(tabla_ing_aut)[3] <- "region" 
# names(tabla_ing_aut)[1] <- "region_c" 
  tabla_ing_aut <- tabla_3[,c("region","2009")]
...
tabla_2009$promedio_2009 <- as.numeric(tabla_2009$promedio_2009)
