...
### Ingreso del trabajo hogar: yautcorh 2009-2020
...
```{r}
setdiff(unique(casen2020$r3),unique(casen2017$r3)) 
```
```{r}
###
...
ytotcor|yautcor|ytrabajocor|yoprcor
