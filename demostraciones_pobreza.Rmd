...
Las tablas antiguas fueron corregidas según una nueva metodología.
...
indigente_por
```
Coinciden. Pero no podemos ampliar a  nivel de comunas.
...
podriamos construir un indicador que relaciones frecuencias y no porcentajes que difieren segun metodologia, asi por emeplo, en iquique para el 2006 hubo 2147 indigentes, eso representa una cantidad que puede relacionarse con el total nacional de personas.

Un indice asi podria llamarase: ICP indice comparativo de la pobreza.
